...
<div class = "container">
	...
	<div class = "col-md-6">
		...
		<h2> Here, you can view a writer or add your favourite writer to our database </h2>
		<h3> Add a writer </h3>
		<form action = "insertWriter.php" method = "post">
...
echo "Below is the writers' name and how many years they've been active: <br><br>";
